							...
							<div class="bs-example4" data-example-id="contextual-table">
								<table class="table">
									...
									<tbody>
										...
										%>
										<tr class="active">
											<th scope="row"><img src="image/<%=p.getImage()%>"
												height="100px" width="100px" class="img-fluid" alt=""></th>
											<td><%=p.getPname() %> </a></td>
											<td><%=p.getPprice()%></td>
											...
											<td><%=p.getPid()%></td>
											<td><%=p.getSid()%></td>
											<td><a href="seller-edit.jsp?id=<%=p.getPid()%>">Edit</a></td>
											<td><a href="seller-delete.jsp?id=<%=p.getPid()%>">Delete</a></td>
										</tr>
										<%
										}
										%>
