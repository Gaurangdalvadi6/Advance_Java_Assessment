...
<%
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="SellerController" method="post">
						...
						<div class="right-w3l">
							<input type="submit" class="form-control" value="Log in" name="action">
						</div>
						<div class="sub-w3l">
	...
	<div class="modal-body">
					<form action="ProductController" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<input type="hidden" class="form-control" name="sid" value="<%=s.getId()%>">
						</div>
						<div class="form-group">
						...
						<div class="right-w3l">
							<input type="submit" class="form-control" value="upload" name="action">
						</div>
