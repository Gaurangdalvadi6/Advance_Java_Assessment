...
public class ProductController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("upload")){
			String savePath = "C:\\Users\\GAURANG\\Desktop\\Advance_Java_Assessment\\Adance_Java_Assessment\\src\\main\\webapp\\image";   
		    ...
		    String savePath2 = "C:\\Users\\GAURANG\\Desktop\\Advance_Java_Assessment\\Adance_Java_Assessment\\src\\main\\webapp\\image";
		...
		else if(action.equalsIgnoreCase("changes update")) {
			String savePath = "C:\\Users\\GAURANG\\Desktop\\Advance_Java_Assessment\\Adance_Java_Assessment\\src\\main\\webapp\\image";   
			File fileSaveDir=new File(savePath);
	        if(!fileSaveDir.exists()){
	            fileSaveDir.mkdir();
